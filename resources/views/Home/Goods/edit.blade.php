        ...
        <div class="am-modal am-modal-no-btn" id="doc-modal-1">
            ...
            <div class="add-dress" style="width: 700px;">
                ...
                <div class="am-cf am-padding" style="margin-left: 40px;">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">修改商品</strong> / <small>add goods</small></div>
                </div>
                <hr/>

                <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                    <form class="am-form am-form-horizontal" method="post" action="{{url('home/goods/doedit/'.$good->gid)}}">
                        {{csrf_field()}}
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="text" id="user-name" placeholder="商品名称" name="gname" value="{{$good->gname}}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input id="user-phone" placeholder="商品价格" type="text" name="gprice" value="{{$good->gprice}}">
                            </div>
                        </div>
                        <div class="am-form-group">
...
//                                                            $('#img1').attr('src','http://project193.oss-cn-beijing.aliyuncs.com/'+data);
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-form-content">
                                    <textarea name="gdesc" style="height: 100px;">{!! $good->gdesc !!}</textarea>
                                </div>
                            </div>
