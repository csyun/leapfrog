                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="{{url('admin/goodtagtype/'.$goodtagtype->tid)}}" method="post">
                                    {{csrf_field()}}
                                    {{method_field('put')}}
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            ...
                                            @foreach($cates as $k=>$v)
                                                <input type="checkbox"  name="cid[]" value="{{$v->cid}}"
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" id="user-weibo" placeholder="请添加标签类型" name="tag_type" value="{{$goodtagtype->tag_type}}">
                                            <div>
