            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="{{url('/admin/recommend')}}" id="art_form" class="am-form tpl-form-border-form tpl-form-border-br" method="post" enctype="multipart/form-data">
                        ...
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">推荐位标题 <span class="tpl-form-line-small-title">Name</span></label>
                            <div class="am-u-sm-9">
                                <input style="width: 400px;" type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题" name="title" value="{{old('title')}}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" size="40" id="art_thumb" name="rpic" value="{{old('rpic')}}" style="width: 400px;" >
                                <input id="file_upload" name="file_upload" type="file" multiple="true" style="margin-top: 20px;">
                                <br>
                                <img src="http://leapfrog.oss-cn-beijing.aliyuncs.com/{{old('rpic')}}" id="img1" alt="" style="width:80px;height:80px">
