...
<script src="{{asset('/layer/layer.js')}}"></script>
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 权限添加: <small>users</small></div>
                                    <p class="page-header-description">添加权限</p>
                                    @if (count($errors) > 0)
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="{{url('/admin/permission/')}}" method="post" enctype="multipart/form-data" class="am-form tpl-form-border-form tpl-form-border-br">
                                    {{csrf_field()}}
                                    <div class="am-form-group">

                                        <label for="user-name" class="am-u-sm-3 am-form-label">权限名 : <span  class="tpl-form-line-small-title"></span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="pname" id="pname"  class="tpl-form-input"  placeholder="请输入权限名">
                                            <small></small>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="desc" value="" class="tpl-form-input" id="desc" placeholder="请输入权限描述">
    ...
    <script type="text/javascript">
        ...
        $("#pname").blur(function() {
            ...
            $.ajax({
                    type:"post",
                    url:"{{url('/admin/permission/ajax')}}",
                    data:{"pname":v,"_token":"{{csrf_token()}}"},
                    success:function(data){
                        if(data){
                             layer.msg("权限名已存在！", {icon: 6});
                        }
                    },
