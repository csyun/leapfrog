        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="{{url('/admin/recyclegoods/'.$recyclegood->rgid)}}" id="art_form" class="am-form tpl-form-border-form tpl-form-border-br" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('put')}}
                        <div class="am-form-group">
                            ...
                            @endif
                                ...
                                <div class="am-u-sm-9">
                                    <input style="width: 400px;" type="text" class="tpl-form-input" id="user-name" placeholder="请输入名称" name="rgname" value="{{$recyclegood->rgname}}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="{{$recyclegood->rgprice}}" name="rgprice" placeholder="输入商品基础价格" style="width: 400px;">
                            </div>
                        </div>
                        <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="type_id" onchange="getAttr(this)">
                                            @foreach($recyclegoodtype as $k=>$v)
                                                @if($recyclegood->type_id==$v->type_id)
                         ...
                         @foreach($recycleattr as $k=>$v)
                             <div class="am-form-group">
                                <label for="user-phone" class="am-u-sm-3 am-form-label">{{$v->attr_name}} <span class="tpl-form-line-small-title">Type</span></label>
                                 ...
                                 <div class="am-u-sm-9" @if ($k3>0) style="margin-left:280px;" @endif>
                                     <input type="text" readonly  name="attr_value[]"  value="{{$v3['attr_value']}}" style="width: 200px;">
                                     <input type="text" name="attr_price[]"  value="{{$v3['attr_price']}}" placeholder="" style="margin-left: 232px;width: 200px;margin-top: -33px;">
                                     <input type="hidden" value="{{$v->attr_id}}" name="attr_id[]" >
                                     <span style="margin-right:267px;width:100px;margin-top: -33px;float: right"  class="addtag" onclick="delSel(this)">-</span>
                                 </div>
                                 @endforeach
                                 @endif

                                <div class="am-u-sm-9" id="select-id{{$v->attr_id}}" style="margin-left:280px;">
                                ...
                                <input type="text" value="" name="attr_price[]" placeholder="输入属性价格" style="margin-left: 232px;width: 200px;margin-top: -33px;">
                                    <input type="hidden" value="{{$v->attr_id}}" name="attr_id[]" placeholder="输入属性价格" style="margin-left: 232px;width: 200px;margin-top: -33px;">
                                 <span style="margin-right:267px;width:100px;margin-top: -33px;float: right"  class="addtag" onclick="addSel({{$v->attr_id}})">+</span>
                                </div>
                            </div>
                         @endforeach
                        @endif
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" size="40" id="art_thumb" name="rgpic" value="{{$recyclegood->rgpic}}" style="width: 400px;" >
                                <input id="file_upload" name="file_upload" type="file" multiple="true" style="margin-top: 20px;">
                                <br>
                                <img src="http://leapfrog.oss-cn-beijing.aliyuncs.com/{{$recyclegood->rgpic}}" id="img1" alt="" style="width:80px;height:80px">
...
<script>
    ...
    function addSel(id) {
       ...
       new_div.find('.addtag').text("-").attr('onclick','delSel(this)');
        ...
        //alert(new_div.parent('am-u-sm-9').html());
