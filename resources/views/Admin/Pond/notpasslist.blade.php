                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf"><h2>未通过审核蛙塘列表</h2></div>
                                @if (count($errors) > 0)
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <!-- 搜索 -->
                                <form action="{{url('/admin/pond/notpasslist')}}" method="get">
                                {{csrf_field()}}
											...
											<tr>
												...
												<td>
                                                    <div class="tpl-table-black-operation">
                                                        ...
                                                        <a href="javascript:;" onclick="wait({{$v->mid}})" class="tpl-table-black-operation-del">
