...
@section('content')
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf" ><h2>已通过审核蛙塘列表</h2></div>
                                @if (count($errors) > 0)
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="{{url('admin/pond')}}"><button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 
                                                等待审核蛙塘列表</button></a>
                                ...
                                <!-- 搜索 -->
                                <form action="{{url('/admin/pond/passlist')}}" method="get">
                                {{csrf_field()}}
											...
											<tr>
												...
												<td>
                                                    <div class="tpl-table-black-operation">
                                                        ...
                                                        <a href="javascript:;" id="pass" onclick="wait({{$v->mid}})" class="tpl-table-black-operation-del">
                                                            <i class="am-icon-trash"></i> 重新等待审核
                                                        </a>
        ...
        <script>
            ...
            function wait(id) {
                ...
                layer.confirm('您确认重新等待审核吗？', {
                    btn: ['确认','取消'] //按钮
                }, function(){

                $.ajax({
                    type:"post",
                    url:"{{url('/admin/pond/wait')}}",
                    data:{"mid":id,"_token":"{{csrf_token()}}"},
                    success:function(data){
                        if(data){
                            layer.msg("重新等待审核！", {icon: 6});
                            var t=setTimeout("location.href = location.href;",2000);
                        }else{
                            layer.msg("重新等待审核操作失败！", {icon: 6});
                            var t=setTimeout("location.href = location.href;",2000);
                        }
                    },
