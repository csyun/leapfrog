            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <form action="{{url('/admin/idea')}}" id="art_form" class="am-form tpl-form-border-form tpl-form-border-br" method="post" enctype="multipart/form-data">
                        ...
                        <div class="am-u-sm-9">
                            <input style="width: 400px;" type="text" class="tpl-form-input" id="user-name" placeholder="请输入url" name="content" value="{{old('content')}}">
                            <small>请填写意见反馈内容</small>
                        </div>
                        <label for="user-name" class="am-u-sm-3 am-form-label">反馈时间 <span class="tpl-form-line-small-title">Time</span></label>
                            <div class="am-u-sm-9">
                                <input style="width: 400px;" type="text" class="tpl-form-input" id="user-name" name="create_time" value="{{old('create_time')}}">
                                <small></small>
                            </div>
                        <div class="am-form-group">
